...
import { getPatreon } from "../src/lib/api/client";
            ...
            >
                ...
                >
                    <Circle
                        sx={{
                            backgroundColor:
                                iconNum % 2 == 0 ? "primary.main" : "secondary.main",
                        }}
                        className={Styles.reasons__icons}
                    >
                        {icon}
                    </Circle>
                    <Typography sx={{ marginLeft: "1rem" }} variant="h6">
                        {reason.catch.toUpperCase()}
                    </Typography>
                </AccordionSummary>
                <AccordionDetails
                    sx={{
...
const Patreon = (props: Props): JSX.Element => {
    ...
    return (
        <Layout backgroundImageUrl={data.background}>
            <React.Fragment>
                <Paper elevation={4} className={Styles.patreonPaper}>
                    <Stack direction="column" spacing={0} className={Styles.top}>
                        ...
                        <Stack direction="column" spacing={0} className={Styles.reasons}>
